...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qot959a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qot959a.containers.anotherwebservice.com/
...
```
git clone git@github.com:gregster2u/container-qot959a.git
cd container-qot959a
```
...
```
docker attach container-qot959a
```
